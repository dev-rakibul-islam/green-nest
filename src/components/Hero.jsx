...
const slides = [
  {
    ...
    image: "https://i.ibb.co.com/6J7hh5pz/1.png",
  },
  {
    title: "Breathe Easy, Live Green",
    subtitle: "Air‑purifying favorites for brighter, calmer spaces.",
    image: "https://i.ibb.co.com/NdNWK5p8/2.png",
  },
  {
    title: "Grow With Confidence",
    subtitle: "Tips, tools, and expert advice at your fingertips.",
    image: "https://i.ibb.co.com/JjmNcTnf/3.png",
  },
];
  ...
  return (
    <div className="mb-10 mt-0">
      ...
      >
        {slides.map((s, idx) => (
          <SwiperSlide key={idx}>
            <div className="relative h-[360px] md:h-[560px] w-full">
              <div
